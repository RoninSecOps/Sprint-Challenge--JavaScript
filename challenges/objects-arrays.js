...
console.log(dinTyrannosaurus.weight);

// What was the diet of a velociraptor?
console.log(dinStegosaurus.diet);

// How long was a stegosaurus?
console.log(dinVelociraptor.length);

// What time period did tyrannosaurus live in?
console.log(dinTyrannosaurus.period);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(dinTyrannosaurus.roar());
...
*/
const displayNames = [];
zooAnimals.forEach(scientificName => {
  displayNames.push(scientificName.animal_name);
});
...
zooAnimals.map(animalNameLow => {
  lowCaseAnimalNames.push(animalNameLow.animal_name.toLocaleLowerCase());
});
...
zooAnimals.filter(lowerPopulation => {
  if (lowerPopulation.population < 5) {
    lowPopulationAnimals.push(lowerPopulation);
  }
});
...
*/
const populationTotal = zooAnimals.reduce((acc, totalPopulation) => {
